...
export IMAGE_URL=${IMAGE_URL-jfrog-artifactory.apps.rhopp241115.devcluster.openshift.com/rhtap-docker/rhtap-qe:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhopp-rhtap-testing/ugftpbssq-dotnet-basic-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rhopp241115.devcluster.openshift.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rhopp241115.devcluster.openshift.com}
